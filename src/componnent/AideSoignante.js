...
export default function AideSoignante() {
  return (
    <div class="relative bg-cyan-200 pt-[120px] pb-[110px] lg:pt-[150px]">
          ...
          <div class="w-full px-4 lg:w-5/12">
            <div class="hero-content">
              ...
              <p class="mb-8 max-w-[480px] text-base text-body-color">
                With bouchra, business and students thrive together. Business
              ...
              <ul class="flex flex-wrap items-center">
                <li>
                  <a
                    href="/"
                    class="inline-flex items-center justify-center rounded-lg bg-primary py-4 px-6 text-center text-base font-normal text-black-200 hover:bg-opacity-90 sm:px-10 lg:px-8 xl:px-10"
                  >
