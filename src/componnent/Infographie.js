            ...
            <div class="hero-content">
              ...
              <ul class="flex flex-wrap items-center">
                <li>
                  <a
                    href="/"
                    class="inline-flex items-center justify-center rounded-lg bg-primary py-4 px-6 text-center text-base font-normal text-black hover:bg-blue-90 sm:px-10 lg:px-8 xl:px-10"
                  >
